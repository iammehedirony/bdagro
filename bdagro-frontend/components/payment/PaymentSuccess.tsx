    ...
    const receiptQuery = useQuery({
        ...
        queryFn: async () => {
            const response = await api.get<{ receipt: PaymentReceipt }>(
                `/investors/transactions/${transactionId}/receipt`,
            );
                ...
                <div className="border border-stone-200">
                    <div className="p-8 text-center border-b border-stone-200">
                        ...
                        <p className="mt-2 text-sm text-stone-500">
                            আপনার বিনিয়োগ সফলভাবে সম্পন্ন হয়েছে। কৃষককে জানানো
                            হয়েছে।
                        </p>
                    </div>
                    {!transactionId && (
                        <div className="p-6 text-sm text-red-600">
                            লেনদেনের তথ্য পাওয়া যায়নি।
                        </div>
                    )}
                    {transactionId && receiptQuery.isLoading && (
                        <div className="p-6 text-sm text-stone-500">
                            রসিদের তথ্য লোড হচ্ছে...
                        </div>
                    )}
                    {transactionId && receiptQuery.isError && (
                        <div className="p-6 text-sm text-red-600">
                            রসিদের তথ্য এখনো প্রস্তুত নয়। কিছুক্ষণ পর আবার
                            চেষ্টা করুন।
                        </div>
                    )}
                    {receipt && (
                        <div className="p-6 space-y-3">
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="text-stone-800">
                                    {receipt.relatedInvestment?.project
                                        ?.title ?? "-"}
                                </span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="text-stone-800 break-all text-right ml-4">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="text-stone-800 text-right ml-4">
                    ...
                    <div className="p-6 pt-0 flex flex-col gap-3">
                        <Link
                            ...
                            type="button"
                            className="w-full bg-emerald-900 text-white py-3 text-sm hover:bg-emerald-800 flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="w-full border border-stone-300 text-stone-700 py-3 text-sm hover:border-emerald-800 disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            <Download className="w-4 h-4" /> রসিদ ডাউনলোড করুন
                        </button>
                    </div>
                </div>
            </div>
