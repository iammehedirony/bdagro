          ...
          <div className="relative">
            ...
            <div className="space-y-10 relative">
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-primary-900 flex items-center justify-center shrink-0 z-10">
                  <CheckCircle2 className="w-4 h-4 text-white" />
                </div>
                <div>
                  <div className="text-sm text-neutral-900">অ্যাকাউন্ট তৈরি</div>
                  <div className="text-xs text-neutral-400 mt-0.5">সম্পন্ন</div>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-accent-500 flex items-center justify-center shrink-0 z-10">
                  <CreditCard className="w-4 h-4 text-primary-950" />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-neutral-100 border border-neutral-300 flex items-center justify-center shrink-0 z-10">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-300 mt-0.5">লকড</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="border border-neutral-200">
              ...
              <div className="p-8 space-y-6">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1.5 w-full border border-neutral-300 px-3 py-2.5 text-sm placeholder:text-neutral-300 focus:outline-none focus:border-primary-700"
                    />
                  </div>
                  <div>
                    <label className="text-sm text-neutral-700">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="text-sm text-neutral-700">জন্ম তারিখ</label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  <div className="border border-dashed border-neutral-300 p-6 flex items-center gap-4 hover:border-primary-700 transition-colors cursor-pointer">
            ...
            {/* STATUS LEGEND */}
            <div className="mt-6 border border-neutral-200 p-5 flex flex-wrap items-center gap-3">
            ...
            {/* LOCKED STEP PREVIEW */}
            <div className="mt-6 border border-neutral-200 bg-neutral-50 p-8 opacity-60">
              ...
              <div className="mt-5 grid sm:grid-cols-2 gap-5">
                {[
                  ...
                  <div key={f}>
                    <label className="text-sm text-neutral-400">{f}</label>
                    <div className="mt-1.5 w-full border border-neutral-200 bg-white h-10" />
                  </div>
                ))}
              </div>
            </div>
