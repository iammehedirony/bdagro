        ...
        <div className="px-6 sm:px-12 py-10 max-w-xl w-full mx-auto">
          ...
          <div className="mt-8 space-y-5">
            ...
            <div>
              ...
              <select className="mt-1.5 w-full border border-neutral-300 px-3 py-2.5 text-sm text-neutral-600 focus:outline-none focus:border-primary-700">
            ...
            <label className="flex items-start gap-2 text-xs text-neutral-500">
              <input type="checkbox" className="accent-primary-800 mt-0.5" defaultChecked />
              <span>
            ...
            <div className="text-center text-sm text-neutral-400">
              ...
              <span className="text-primary-900">লগইন করুন</span>
            </div>
          </div>
        </div>

        {/* RIGHT: TRUST PANEL */}
        <div className="bg-primary-950 px-10 py-14 flex flex-col justify-center">
          <h2 className="text-2xl text-neutral-50 leading-snug">
          ...
          <div className="mt-8 space-y-6">
            {[
              ...
              <div key={f.title} className="flex gap-4">
                <f.icon className="w-5 h-5 text-accent-400 shrink-0 mt-0.5" />
                <div>
                  <div className="text-neutral-100 text-sm">{f.title}</div>
                  <div className="text-primary-100/60 text-xs mt-1 leading-relaxed">
                    {f.body}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-10 pt-8 border-t border-primary-900 flex items-center justify-between text-primary-100/70 text-sm">
            <div>
