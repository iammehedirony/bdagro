      ...
      <div className="flex-1 min-w-0">
        <div className="p-8 max-w-2xl space-y-10">
          ...
          <div>
            ...
            <div className="border border-neutral-200 p-6 flex items-center gap-4">
              <div className="w-11 h-11 bg-primary-50 border border-primary-600 rounded-full flex items-center justify-center shrink-0">
                <ShieldCheck className="w-5 h-5 text-primary-700" />
              </div>
              <div className="flex-1">
                <div className="text-sm text-neutral-800">যাচাইকৃত</div>
          ...
          <div>
            ...
            <div className="border border-neutral-200 p-6 grid sm:grid-cols-2 gap-5">
              <div>
                <label className="text-sm text-neutral-700">পেমেন্ট মাধ্যম</label>
