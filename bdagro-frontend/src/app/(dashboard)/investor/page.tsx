          ...
          <div>
            ...
            <div className="mt-8 border border-stone-200">
              <div className="p-6 border-b border-stone-200 flex items-center justify-between">
                ...
                <span className="text-xs text-stone-400">৩টি প্রকল্প</span>
              </div>
                ...
                {investments.map((inv) => (
                  <div key={inv.name} className="p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="text-stone-900">{inv.name}</div>
          ...
          <div className="space-y-8">
            ...
            <div className="border border-stone-200 p-6">
              ...
              <div className="h-2 w-full flex overflow-hidden">
                <div className="bg-emerald-600" style={{ width: "40%" }} />
                <div className="bg-amber-500" style={{ width: "35%" }} />
              ...
              <div className="divide-y divide-stone-200">
                {notifications.map((n, i) => (
                  <div key={i} className="p-5 flex gap-3">
                    <n.icon className="w-4 h-4 text-emerald-700 mt-0.5 shrink-0" />
                    <div>
