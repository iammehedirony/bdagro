...
import { getAdminDashboard, listAdminAllProjects, listAdminLoanApplications, listAdminTransactions, listAdminUsers, listAdminVerifications } from "@/lib/services/admin.service";
...
export function useAdminTransactionsQuery() { const api = useApi(); return useQuery({ queryKey: queryKeys.admin.transactions, queryFn: () => listAdminTransactions(api) }); }
